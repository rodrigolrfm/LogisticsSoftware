<template>
  <a-layout style="min-height: 100vh">
    ...
    <a-row justify="center">
      <a-col>
        <p class="dashboard-title">Solicitud N° {{guia}}</p>
      </a-col>
    </a-row>
    <a-row justify="left">
        <a-col>
    ...
    <a-row justify="left">
        ...
        <a-col><p class="label">Fecha de Entrega: </p></a-col>
    </a-row>
    <a-row justify="left">
        <a-col><p class="labelTitulo">{{guia}} </p></a-col>
        <a-col><p class="labelTitulo">{{fechaEntrega}} </p></a-col>
    </a-row>
    <a-row>
        <a-col :span="8">
        <p>Descripción</p><br>
...
export default {
  ...
  async created(){
    ...
    this.fechaEntrega=sessionStorage.fechaEntrega;
    this.sugerencia=sessionStorage.sugerencia;
  }
}
</script>
