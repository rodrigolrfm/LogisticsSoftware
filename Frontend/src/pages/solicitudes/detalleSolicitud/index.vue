    ...
    async obtenerDetalleSolicitud(){
      ...
      try{
        ...
        if(true){//data.data.status=="sucess"
            ...
            this.fechaEntrega=this.formatearFechas(data.fechaEntrega);
            this.servicio=data.servicio;
            this.numeroPaquete=data.numeroPaquete;
            this.contadorVisitas=data.contadorVisitas;
            this.distritoDestino=data.distritoDestino;
            this.provinciaDestino=data.provinciaDestino;
            this.departamentoDestino=data.departamentoDestino;
            this.primeraDireccion=data.primeraDireccion;
            this.segundaDireccion=data.segundaDireccion;
            this.fechaEmbarque=this.formatearFechas(data.fechaEmbarque);
            this.fechaSalidaProyectada=this.formatearFechas(data.fechaSalidaProyectada);
            this.fechaLlegadaReal=this.formatearFechas(data.fechaLlegadaReal);
            this.via=data.via;
            this.cliente=data.cliente;
            this.proveedor=data.proveedor;
            this.fechaManifiesto=this.formatearFechas(data.fechaManifiesto);
            this.estadoManifiesto=data.estadoManifiesto;
            this.incidenciaManifiesto=data.incidenciaManifiesto;
            this.fechaManifiestoRecogido=this.formatearFechas(data.fechaManifiestoRecogido);
            this.fechaManifiestoInformado=this.formatearFechas(data.fechaManifiestoInformado);
            this.fechaManifiestoVerificado=this.formatearFechas(data.fechaManifiestoVerificado);
            this.fechaCompromiso=this.formatearFechas(data.fechaCompromiso);
            this.fechaReparto=this.formatearFechas(data.fechaReparto);
            this.tipoIncidenciaReparto=data.tipoIncidenciaReparto;
            this.fechaIncidenciaReparto=this.formatearFechas(data.fechaIncidenciaReparto);
